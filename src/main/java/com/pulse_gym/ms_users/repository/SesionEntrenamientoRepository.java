...
public interface SesionEntrenamientoRepository extends JpaRepository<SesionEntrenamiento, Long> {
        ...
        /**
         * Cuenta las sesiones de un socio desde una fecha específica
         * 
         * @param idSocio     ID del socio
         * @param fechaInicio Fecha desde la cual contar
         * @return Número de sesiones desde la fecha
         */
         ...
         */
        @Query("SELECT COUNT(s) FROM SesionEntrenamiento s WHERE s.socio.idUsuario = :idSocio AND s.fechaSesion BETWEEN :fechaInicio AND :fechaFin")
        Long countSesionesEnPeriodo(@Param("idSocio") Long idSocio,
